...
ols_step_forward_aic(lm(Y~.,data=subset(cont,select=-c(log_median,median, major_code, p25th, p75th))), details = T)
ols_step_forward_p(lm(Y~.,data=subset(cont,select=-c(log_median,median, major_code, p25th, p75th))), details = T)
...
ols_step_backward_aic(lm(Y~.,data=subset(cont,select=-c(log_median,median, major_code, p25th, p75th))), details = T)
ols_step_backward_p(lm(Y~.,data=subset(cont,select=-c(log_median,median, major_code, p25th, p75th))), details = T)
