---
title: "STAT 151A Final Group Project"
...
We will be building an OLS model to explain the association between major category and median income and evaluate its effectiveness.

### Dataset 

The dataset we use is the college_recent-grad dataset from fivethirtyeight.  
...
```{r data_cleaning, echo = F,fig.align = "center",fig.width=7, fig.height=4}
# load data
...
```{r visualizations, echo = F,fig.width=7, fig.height=3}
...
#if the model overfits, it shouldn't be able to predict the test set that well
