...
table(college_recent_grads$major_category)
colnames(crg)
model.experiment <- train(log_median ~ employed + employed_fulltime_yearround + 
                          college_job_prop +
                          major_category_Biology...Life.Science+
...
model.experiment$results[,"RMSE"]
model.experiment_rsme
```
