...
```{r forward_backward_visualized, echo = F, fig.cap = "Figure 3: Progression of variable selection", fig.align='center'}
par(mfrow=c(2,3))
...
par(mfrow=c(2,2))
plot(model.inter_reduced, which = 1, sub = "Figure 5a")
plot(model.inter_reduced, which = 2, sub = "Figure 5b")
plot(model.inter_reduced, which = 3, sub = "Figure 5c")
plot(model.inter_reduced, which = 5, sub = "Figure 5d")
